...
class AlgoCompiler:
    def __init__(self, code, input_str, debug=True, _debug_print=None):
        self.steck = []
        self.num_line = 0
        self.line = ""
    ...
    def compile_block(self, block):
        ...
        while block_i < len(block):
            ...
            self.line = line = block[block_i][1][1]
    ...
    def replace(self, params):
        if len(params) == 2:
            ...
            self.variable = self.variable.replace(params[0], params[1], 1)
        else:
...
if __name__ == '__main__':
    print(AlgoCompiler(code, "1" * 66).compile())
